...
-- Generated: 2026-09-09T06:27:41.574Z
...
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_accountId_not_null" NOT NULL "accountId";
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_providerId_not_null" NOT NULL "providerId";
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_updatedAt_not_null" NOT NULL "updatedAt";
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_userId_fkey" FOREIGN KEY ("userId") REFERENCES neon_auth."user"(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."account" ADD CONSTRAINT "account_userId_not_null" NOT NULL "userId";
CREATE INDEX "account_userId_idx" ON neon_auth.account USING btree ("userId");
-- no rows in "neon_auth"."account"
...
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_email_not_null" NOT NULL email;
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_expiresAt_not_null" NOT NULL "expiresAt";
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_inviterId_fkey" FOREIGN KEY ("inviterId") REFERENCES neon_auth."user"(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_inviterId_not_null" NOT NULL "inviterId";
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES neon_auth.organization(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_organizationId_not_null" NOT NULL "organizationId";
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."invitation" ADD CONSTRAINT "invitation_status_not_null" NOT NULL status;
CREATE INDEX invitation_email_idx ON neon_auth.invitation USING btree (email);
CREATE INDEX "invitation_organizationId_idx" ON neon_auth.invitation USING btree ("organizationId");
-- no rows in "neon_auth"."invitation"
...
ALTER TABLE ONLY "neon_auth"."jwks" ADD CONSTRAINT "jwks_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."jwks" ADD CONSTRAINT "jwks_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."jwks" ADD CONSTRAINT "jwks_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."jwks" ADD CONSTRAINT "jwks_privateKey_not_null" NOT NULL "privateKey";
ALTER TABLE ONLY "neon_auth"."jwks" ADD CONSTRAINT "jwks_publicKey_not_null" NOT NULL "publicKey";
-- no rows in "neon_auth"."jwks"
...
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES neon_auth.organization(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_organizationId_not_null" NOT NULL "organizationId";
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_role_not_null" NOT NULL role;
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_userId_fkey" FOREIGN KEY ("userId") REFERENCES neon_auth."user"(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."member" ADD CONSTRAINT "member_userId_not_null" NOT NULL "userId";
CREATE INDEX "member_organizationId_idx" ON neon_auth.member USING btree ("organizationId");
CREATE INDEX "member_userId_idx" ON neon_auth.member USING btree ("userId");
-- no rows in "neon_auth"."member"
...
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_name_not_null" NOT NULL name;
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_slug_key" UNIQUE (slug);
ALTER TABLE ONLY "neon_auth"."organization" ADD CONSTRAINT "organization_slug_not_null" NOT NULL slug;
CREATE UNIQUE INDEX organization_slug_uidx ON neon_auth.organization USING btree (slug);
-- no rows in "neon_auth"."organization"
...
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_allow_localhost_not_null" NOT NULL allow_localhost;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_created_at_not_null" NOT NULL created_at;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_endpoint_id_key" UNIQUE (endpoint_id);
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_endpoint_id_not_null" NOT NULL endpoint_id;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_name_not_null" NOT NULL name;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_social_providers_not_null" NOT NULL social_providers;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_trusted_origins_not_null" NOT NULL trusted_origins;
ALTER TABLE ONLY "neon_auth"."project_config" ADD CONSTRAINT "project_config_updated_at_not_null" NOT NULL updated_at;

-- Data: 1 rows
INSERT INTO "neon_auth"."project_config" ("id", "name", "endpoint_id", "created_at", "updated_at", "trusted_origins", "social_providers", "email_provider", "email_and_password", "allow_localhost", "plugin_configs", "webhook_config") VALUES
('01bdb6ae-1157-459a-8922-586425600218', 'advrix-crm', 'ep-dark-poetry-az6rk6ec', '2026-08-03T06:16:03.571Z', '2026-08-03T06:16:03.571Z', '[]'::jsonb, '[{"id":"google","isShared":true}]'::jsonb, '{"type":"shared"}'::jsonb, '{"enabled":true,"disableSignUp":false,"emailVerificationMethod":"otp","requireEmailVerification":false,"autoSignInAfterVerification":true,"sendVerificationEmailOnSignIn":false,"sendVerificationEmailOnSignUp":false}'::jsonb, true, '{"magicLink":{"config":{"expiresIn":5,"disableSignUp":false},"enabled":false},"phoneNumber":{"config":{"otp_expires_in":300},"enabled":false},"organization":{"config":{"creatorRole":"owner","membershipLimit":100,"organizationLimit":10,"sendInvitationEmail":false},"enabled":true}}'::jsonb, '{"enabled":false,"enabledEvents":[],"timeoutSeconds":5}'::jsonb);
...
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_expiresAt_not_null" NOT NULL "expiresAt";
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_token_key" UNIQUE (token);
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_token_not_null" NOT NULL token;
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_updatedAt_not_null" NOT NULL "updatedAt";
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_userId_fkey" FOREIGN KEY ("userId") REFERENCES neon_auth."user"(id) ON DELETE CASCADE;
ALTER TABLE ONLY "neon_auth"."session" ADD CONSTRAINT "session_userId_not_null" NOT NULL "userId";
CREATE INDEX "session_userId_idx" ON neon_auth.session USING btree ("userId");
-- no rows in "neon_auth"."session"
...
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_emailVerified_not_null" NOT NULL "emailVerified";
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_email_key" UNIQUE (email);
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_email_not_null" NOT NULL email;
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_name_not_null" NOT NULL name;
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."user" ADD CONSTRAINT "user_updatedAt_not_null" NOT NULL "updatedAt";
-- no rows in "neon_auth"."user"
...
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_createdAt_not_null" NOT NULL "createdAt";
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_expiresAt_not_null" NOT NULL "expiresAt";
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_id_not_null" NOT NULL id;
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_identifier_not_null" NOT NULL identifier;
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_updatedAt_not_null" NOT NULL "updatedAt";
ALTER TABLE ONLY "neon_auth"."verification" ADD CONSTRAINT "verification_value_not_null" NOT NULL value;
CREATE INDEX verification_identifier_idx ON neon_auth.verification USING btree (identifier);
-- no rows in "neon_auth"."verification"
