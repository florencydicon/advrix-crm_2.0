...
export default function TaskDrawer({
  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      <aside className="absolute right-0 top-0 h-full w-full max-w-[460px] bg-night-850 border-l border-white/10 shadow-2xl flex flex-col">
        <div className="flex items-start justify-between gap-3 px-5 py-4 border-b border-white/[0.06]">
          <div className="min-w-0">
            <div className="flex items-center gap-2 text-[11px] text-slate-500 mb-1.5">
              <span>{current.client_name}{current.client_company ? ` · ${current.client_company}` : ""}</span>
