  ...
  if (pipeline.length === 0) {
    return (
      <div className="card flex flex-col items-center justify-center py-10 text-center">
        ...
        <p className="text-xs text-slate-500 mt-1">Sales briefs will land here for approval.</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-400">From brief to delivery — grouped by client.</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {initialClientId && activeClientName && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-brand-300/[0.07] text-brand-300 border border-brand-300/30 hover:bg-brand-300/10 transition-colors"
            >
            ...
            <div key={client.client_id} className="card overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  <span className={`text-slate-500 transition-transform ${clientOpen ? "rotate-90" : ""}`}>
                ...
                <div className="flex items-center gap-2">
                  <span className="badge bg-emerald-400/10 text-emerald-300">{clientDone}/{clientTotalTasks} done</span>
                </div>
              </button>
                ...
                <div className="border-t border-white/[0.06] divide-y divide-white/[0.06]">
                  {client.projects.map((p) => {
                    ...
                    return (
                      <div key={p.id}>
                        {/* Project row */}
                        <div className="flex items-center justify-between gap-3 px-4 py-3 hover:bg-white/[0.04] transition-colors">
                          <button
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            ...
                            {canManage && inProgress && (
                              <button
                                className={`btn-secondary !py-1 !px-2 text-[11px] ${projectOpen ? "bg-brand-300/10 text-brand-300" : ""}`}
                                onClick={() => setOpenProject(projectOpen ? null : p.id)}
                              >
                        ...
                        {projectOpen && (
                          <div className="px-4 pb-3 space-y-3 bg-white/[0.03]">
                            {canManage && inProgress && (
                            ...
                            {p.tasks.length === 0 ? (
                              <p className="text-xs text-slate-500 py-3">No tasks yet.</p>
                            ) : (
                                ...
                                <table className="w-full text-xs">
                                  <thead>
                                    <tr className="border-b border-white/10 bg-white/[0.03]">
                                      ...
                                      <th className="px-3 py-2 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wider w-[100px]">Assignee</th>
